...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=개인 javascript key 적는 곳"></script>
		...
		$(function() {
			...
			$.ajax({
				...
				success : function(array) {
				    ...
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.5116828, 127.059151), // 지도의 중심좌표
				        level: 17 // 지도의 확대 레벨
				    };
